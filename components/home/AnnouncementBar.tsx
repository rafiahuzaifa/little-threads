    ...
    <div className="relative bg-gradient-rainbow bg-[length:400%_400%] animate-gradient py-2.5 px-10 overflow-hidden">
      ...
      <div className="marquee-container">
        <div className="marquee-content">
          <span className="text-white text-sm font-nunito font-semibold whitespace-nowrap tracking-wide">
            {repeatedText}
          </span>
          <span className="text-white text-sm font-nunito font-semibold whitespace-nowrap tracking-wide" aria-hidden>
            {repeatedText}
          </span>
        </div>
      </div>
