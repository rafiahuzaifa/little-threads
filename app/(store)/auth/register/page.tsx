    ...
    <div className="min-h-screen bg-gradient-hero-2 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-float p-8">
          <h1 className="font-nunito font-black text-2xl text-charcoal mb-6">Create Account</h1>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-sm text-gray-400 font-nunito">or create with email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-pink text-white py-3.5 rounded-2xl font-nunito font-bold text-base hover:shadow-pink-lg transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed mt-2"
            >
              {isSubmitting ? (
